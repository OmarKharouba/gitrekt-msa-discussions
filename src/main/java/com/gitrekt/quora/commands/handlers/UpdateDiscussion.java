...
public class UpdateDiscussion extends Command {
  ...
  public Object execute() throws SQLException, BadRequestException, AuthenticationException {
    ...
    if (args.containsKey("title")) {
      modifiedFields.put("title", (String) args.get("title"));
    }

    if (args.containsKey("body")) {
      modifiedFields.put("body", (String) args.get("body"));
    }
    ...
    if (args.containsKey("topic_id")) {
      modifiedFields.put("topic_id", (String) args.get("topic_id"));
    }
